    ...
    },
    {
      ...
      actions: {
        ...
        increment(ctx2, evt) {
          ...
          const value = ctx2.formatter.format((0, import_number_utils3.clamp)(nextValue, ctx2));
        ...
        setRawValue(ctx2, evt) {
          const value = ctx2.formatter.format((0, import_number_utils3.clamp)(evt.value, ctx2));
          set.value(ctx2, value);
        },
        setValue(ctx2, evt) {
