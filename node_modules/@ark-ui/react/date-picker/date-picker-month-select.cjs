...
const DatePickerMonthSelect = react.forwardRef(
  (props, ref) => {
    ...
    const mergedProps = react$1.mergeProps(api.monthSelectProps, props);
    return /* @__PURE__ */ jsxRuntime.jsx(factory.ark.select, { ...mergedProps, ref, children: api.getMonths().map((month, i) => /* @__PURE__ */ jsxRuntime.jsx("option", { value: month.value, children: month.label }, i)) });
  }
);
