...
declare const DatePicker: ForwardRefExoticComponent<DatePickerProps & RefAttributes<HTMLDivElement>> & {
    Root: ForwardRefExoticComponent<DatePickerProps & RefAttributes<HTMLDivElement>>;
    ClearTrigger: ForwardRefExoticComponent<DatePickerClearTriggerProps & RefAttributes<HTMLButtonElement>>;
    Content: ForwardRefExoticComponent<DatePickerContentProps & RefAttributes<HTMLDivElement>>;
    Control: ForwardRefExoticComponent<DatePickerControlProps & RefAttributes<HTMLDivElement>>;
    Input: ForwardRefExoticComponent<DatePickerInputProps & RefAttributes<HTMLInputElement>>;
    Label: ForwardRefExoticComponent<DatePickerLabelProps & RefAttributes<HTMLLabelElement>>;
    MonthSelect: ForwardRefExoticComponent<DatePickerMonthSelectProps & RefAttributes<HTMLSelectElement>>;
    NextTrigger: ForwardRefExoticComponent<DatePickerNextTriggerProps & RefAttributes<HTMLButtonElement>>;
    Positioner: ForwardRefExoticComponent<DatePickerPositionerProps & RefAttributes<HTMLDivElement>>;
    PrevTrigger: ForwardRefExoticComponent<DatePickerPrevTriggerProps & RefAttributes<HTMLButtonElement>>;
    RangeText: ForwardRefExoticComponent<DatePickerRangeTextProps & RefAttributes<HTMLDivElement>>;
    Table: ForwardRefExoticComponent<DatePickerTableProps & RefAttributes<HTMLTableElement>>;
    TableBody: ForwardRefExoticComponent<DatePickerTableBodyProps & RefAttributes<HTMLTableSectionElement>>;
    TableCell: ForwardRefExoticComponent<DatePickerTableCellProps & RefAttributes<HTMLTableCellElement>>;
    TableCellTrigger: ForwardRefExoticComponent<DatePickerTableCellTriggerProps & RefAttributes<HTMLButtonElement>>;
    TableHead: ForwardRefExoticComponent<DatePickerTableHeadProps & RefAttributes<HTMLTableSectionElement>>;
    TableHeader: ForwardRefExoticComponent<DatePickerTableHeaderProps & RefAttributes<HTMLTableCellElement>>;
    TableRow: ForwardRefExoticComponent<DatePickerTableRowProps & RefAttributes<HTMLTableRowElement>>;
    Trigger: ForwardRefExoticComponent<DatePickerTriggerProps & RefAttributes<HTMLButtonElement>>;
    View: ForwardRefExoticComponent<DatePickerViewProps & RefAttributes<HTMLDivElement>>;
    ViewControl: ForwardRefExoticComponent<DatePickerViewControlProps & RefAttributes<HTMLDivElement>>;
    ViewTrigger: ForwardRefExoticComponent<DatePickerViewTriggerProps & RefAttributes<HTMLButtonElement>>;
    YearSelect: ForwardRefExoticComponent<DatePickerYearSelectProps & RefAttributes<HTMLSelectElement>>;
};
