 ...
 */
export default function Prefab_Combo_Input(props) {
    const {
        onDefault, //onBlur
        ariaDescribedby,
        isExpanded,
    ...
    useEffect(() => {
        ...
        function handleSelect(e) {
            ...
            setInputState(inputStates.default)
            SendSelection(e.detail.value)
        }

        //Event listeners
        document.addEventListener(`formReset-${formID}`, handleReset)
        document.addEventListener(`selected-value-${uid}`, handleSelect)
        ...
        return () => {
            ...
            document.removeEventListener(`selected-value-${uid}`, handleSelect)
        }
    }, [value])
    ...
    function SendSelection(selection) {
        const event = new CustomEvent(`selection-${uid}`, {
            detail: {
                value: selection,
            },
            bubbles: true,
...
addPropertyControls(Prefab_Combo_Input, {
    onDefault: {
